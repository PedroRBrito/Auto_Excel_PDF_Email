...
class MainWindow(QMainWindow):
    ...
    def resetar_opcoes(self):
        resposta = QMessageBox.question(self, "Confirmar limpeza", "Deseja realmente limpar todos os campos?", QMessageBox.Yes | QMessageBox.No)
    ...
    def enviar_email(self):
        ...
        EmailUtils.enviar_email(destinatario, titulo_email, corpo, caminho_pdf, remetente, senha, smtp_server, smtp_port)
        print("email enviado!")
